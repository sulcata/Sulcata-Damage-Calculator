...
exports.BattleItems = {
  ...
  adamantorb: {
    ...
    onBasePower: function(basePower, user, target, move) {
      if (
        move &&
        user.baseTemplate.species === "Dialga" &&
  ...
  aguavberry: {
    ...
    gen: 3,
    desc:
      "Restores 1/2 max HP at 1/4 max HP or less; confuses if -SpD Nature. Single use."
  },
  airballoon: {
    id: "airballoon",
    name: "Air Balloon",
  ...
  alakazite: {
    ...
    gen: 6,
    desc:
      "If held by an Alakazam, this item allows it to Mega Evolve in battle."
  },
  aloraichiumz: {
    id: "aloraichiumz",
    name: "Aloraichium Z",
    ...
    gen: 7,
    desc:
      "If held by an Alolan Raichu with Thunderbolt, it can use Stoked Sparksurfer."
  },
  altarianite: {
    id: "altarianite",
    name: "Altarianite",
  ...
  belueberry: {
    ...
    gen: 3,
    desc:
      "Cannot be eaten by the holder. No effect when eaten with Bug Bite or Pluck."
  },
  berryjuice: {
    id: "berryjuice",
    name: "Berry Juice",
  ...
  bugmemory: {
    ...
    onTakeItem: function(item, pokemon, source) {
      if (
        (source && source.baseTemplate.num === 773) ||
        pokemon.baseTemplate.num === 773
      ) {
        return false;
      }
      return true;
  ...
  burndrive: {
    ...
    onTakeItem: function(item, pokemon, source) {
      if (
        (source && source.baseTemplate.num === 649) ||
        pokemon.baseTemplate.num === 649
      ) {
        return false;
      }
      return true;
  ...
  charizarditex: {
    ...
    gen: 6,
    desc:
      "If held by a Charizard, this item allows it to Mega Evolve in battle."
  },
  charizarditey: {
    id: "charizarditey",
    name: "Charizardite Y",
  ...
  decidiumz: {
    ...
    gen: 7,
    desc:
      "If held by a Decidueye with Spirit Shackle, it can use Sinister Arrow Raid."
  },
  deepseascale: {
    id: "deepseascale",
    name: "Deep Sea Scale",
  ...
  diveball: {
    ...
    gen: 3,
    desc:
      "A Poke Ball that works especially well on Pokemon that live underwater."
  },
  domefossil: {
    id: "domefossil",
    name: "Dome Fossil",
  ...
  dracoplate: {
    ...
    onTakeItem: function(item, pokemon, source) {
      if (
        (source && source.baseTemplate.num === 493) ||
        pokemon.baseTemplate.num === 493
      ) {
        return false;
      }
      return true;
  ...
  dragoniumz: {
    ...
    gen: 7,
    desc:
      "If holder has a Dragon move, this item allows it to use a Dragon Z-Move."
  },
  dreadplate: {
    id: "dreadplate",
    name: "Dread Plate",
  ...
  dreamball: {
    ...
    gen: 5,
    desc:
      "A special Poke Ball that appears out of nowhere in a bag at the Entree Forest."
  },
  durinberry: {
    id: "durinberry",
    name: "Durin Berry",
  ...
  duskball: {
    ...
    gen: 4,
    desc:
      "A Poke Ball that makes it easier to catch wild Pokemon at night or in caves."
  },
  earthplate: {
    id: "earthplate",
    name: "Earth Plate",
  ...
  fairiumz: {
    ...
    gen: 7,
    desc:
      "If holder has a Fairy move, this item allows it to use a Fairy Z-Move."
  },
  fairygem: {
    id: "fairygem",
    name: "Fairy Gem",
  ...
  fastball: {
    ...
    gen: 2,
    desc:
      "A Poke Ball that makes it easier to catch Pokemon which are quick to run away."
  },
  fightinggem: {
    id: "fightinggem",
    name: "Fighting Gem",
  ...
  fightiniumz: {
    ...
    gen: 7,
    desc:
      "If holder has a Fighting move, this item allows it to use a Fighting Z-Move."
  },
  figyberry: {
    id: "figyberry",
    name: "Figy Berry",
    ...
    gen: 3,
    desc:
      "Restores 1/2 max HP at 1/4 max HP or less; confuses if -Atk Nature. Single use."
  },
  firegem: {
    id: "firegem",
    name: "Fire Gem",
  ...
  flyiniumz: {
    ...
    gen: 7,
    desc:
      "If holder has a Flying move, this item allows it to use a Flying Z-Move."
  },
  focusband: {
    id: "focusband",
    name: "Focus Band",
  ...
  ghostiumz: {
    ...
    gen: 7,
    desc:
      "If holder has a Ghost move, this item allows it to use a Ghost Z-Move."
  },
  glalitite: {
    id: "glalitite",
    name: "Glalitite",
  ...
  grassiumz: {
    ...
    gen: 7,
    desc:
      "If holder has a Grass move, this item allows it to use a Grass Z-Move."
  },
  grassyseed: {
    id: "grassyseed",
    name: "Grassy Seed",
  ...
  greatball: {
    ...
    gen: 1,
    desc:
      "A high-performance Ball that provides a higher catch rate than a Poke Ball."
  },
  grepaberry: {
    id: "grepaberry",
    name: "Grepa Berry",
  ...
  griseousorb: {
    ...
    onTakeItem: function(item, pokemon, source) {
      if (
        (source && source.baseTemplate.num === 487) ||
        pokemon.baseTemplate.num === 487
      ) {
        return false;
      }
      return true;
  ...
  groundiumz: {
    ...
    gen: 7,
    desc:
      "If holder has a Ground move, this item allows it to use a Ground Z-Move."
  },
  gyaradosite: {
    id: "gyaradosite",
    name: "Gyaradosite",
  ...
  healball: {
    ...
    gen: 4,
    desc:
      "A remedial Poke Ball that restores the caught Pokemon's HP and status problem."
  },
  heatrock: {
    id: "heatrock",
    name: "Heat Rock",
  ...
  iapapaberry: {
    ...
    gen: 3,
    desc:
      "Restores 1/2 max HP at 1/4 max HP or less; confuses if -Def Nature. Single use."
  },
  icegem: {
    id: "icegem",
    name: "Ice Gem",
  ...
  loveball: {
    ...
    gen: 2,
    desc:
      "Poke Ball for catching Pokemon that are the opposite gender of your Pokemon."
  },
  lucarionite: {
    id: "lucarionite",
    name: "Lucarionite",
  ...
  lumberry: {
    ...
    gen: 3,
    desc:
      "Holder cures itself if it is confused or has a major status condition. Single use."
  },
  luminousmoss: {
    id: "luminousmoss",
    name: "Luminous Moss",
  ...
  lustrousorb: {
    ...
    onBasePower: function(basePower, user, target, move) {
      if (
        move &&
        user.baseTemplate.species === "Palkia" &&
  ...
  luxuryball: {
    ...
    gen: 3,
    desc:
      "A comfortable Poke Ball that makes a caught wild Pokemon quickly grow friendly."
  },
  machobrace: {
    id: "machobrace",
    name: "Macho Brace",
    ...
    gen: 3,
    desc:
      "Holder's Speed is halved. The Ability Klutz does not ignore this effect."
  },
  magnet: {
    id: "magnet",
    name: "Magnet",
  ...
  magoberry: {
    ...
    gen: 3,
    desc:
      "Restores 1/2 max HP at 1/4 max HP or less; confuses if -Spe Nature. Single use."
  },
  magostberry: {
    id: "magostberry",
    name: "Magost Berry",
  ...
  manectite: {
    ...
    gen: 6,
    desc:
      "If held by a Manectric, this item allows it to Mega Evolve in battle."
  },
  marangaberry: {
    id: "marangaberry",
    name: "Maranga Berry",
  ...
  marshadiumz: {
    ...
    gen: 7,
    desc:
      "If held by Marshadow with Spectral Thief, it can use Soul-Stealing 7-Star Strike."
  },
  masterball: {
    id: "masterball",
    name: "Master Ball",
  ...
  metronome: {
    ...
    effect: {
      ...
      onModifyDamage: function(damage, source, target, move) {
        let numConsecutive =
          this.effectData.numConsecutive > 5
            ? 5
            : this.effectData.numConsecutive;
  ...
  nestball: {
    ...
    gen: 3,
    desc:
      "A Poke Ball that works especially well on weaker Pokemon in the wild."
  },
  netball: {
    id: "netball",
    name: "Net Ball",
  ...
  normaliumz: {
    ...
    gen: 7,
    desc:
      "If holder has a Normal move, this item allows it to use a Normal Z-Move."
  },
  occaberry: {
    id: "occaberry",
    name: "Occa Berry",
  ...
  pikashuniumz: {
    ...
    gen: 7,
    desc:
      "If held by cap Pikachu with Thunderbolt, it can use 10,000,000 Volt Thunderbolt."
  },
  pinapberry: {
    id: "pinapberry",
    name: "Pinap Berry",
  ...
  pokeball: {
    ...
    gen: 1,
    desc:
      "A device for catching wild Pokemon. It is designed as a capsule system."
  },
  pomegberry: {
    id: "pomegberry",
    name: "Pomeg Berry",
  ...
  primariumz: {
    ...
    gen: 7,
    desc:
      "If held by a Primarina with Sparkling Aria, it can use Oceanic Operetta."
  },
  protectivepads: {
    id: "protectivepads",
  ...
  quickball: {
    ...
    gen: 4,
    desc:
      "A Poke Ball that provides a better catch rate at the start of a wild encounter."
  },
  quickclaw: {
    id: "quickclaw",
    onModifyPriorityPriority: -1,
    ...
    onAfterMoveSecondary: function(target, source, move) {
      if (
        ...
        if (
          ...
          return;
        if (target.useItem(null, source)) {
          // This order is correct - the item is used up even against a pokemon with Ingrain or that otherwise can't be forced out
  ...
  repeatball: {
    ...
    gen: 3,
    desc:
      "A Poke Ball that works well on Pokemon species that were previously caught."
  },
  rindoberry: {
    id: "rindoberry",
    name: "Rindo Berry",
  ...
  safariball: {
    ...
    gen: 1,
    desc:
      "A special Poke Ball that is used only in the Safari Zone and Great Marsh."
  },
  safetygoggles: {
    id: "safetygoggles",
    name: "Safety Goggles",
    ...
    onTryHit: function(pokemon, source, move) {
      if (
        move.flags["powder"] &&
        pokemon !== source &&
        this.getImmunity("powder", pokemon)
      ) {
  ...
  salacberry: {
    ...
    gen: 3,
    desc:
      "Raises holder's Speed by 1 stage when at 1/4 max HP or less. Single use."
  },
  salamencite: {
    id: "salamencite",
    name: "Salamencite",
  ...
  snorliumz: {
    ...
    gen: 7,
    desc:
      "If held by a Snorlax with Giga Impact, it can use Pulverizing Pancake."
  },
  snowball: {
    id: "snowball",
    name: "Snowball",
  ...
  souldew: {
    ...
    onBasePower: function(basePower, user, target, move) {
      if (
        move &&
        (user.baseTemplate.num === 380 || user.baseTemplate.num === 381) &&
  ...
  steeliumz: {
    ...
    gen: 7,
    desc:
      "If holder has a Steel move, this item allows it to use a Steel Z-Move."
  },
  stick: {
    id: "stick",
    name: "Stick",
  ...
  tapuniumz: {
    ...
    gen: 7,
    desc:
      "If held by a Tapu with Nature's Madness, it can use Guardian of Alola."
  },
  terrainextender: {
    id: "terrainextender",
  ...
  thickclub: {
    ...
    onModifyAtk: function(atk, pokemon) {
      if (
        pokemon.baseTemplate.baseSpecies === "Cubone" ||
        pokemon.baseTemplate.baseSpecies === "Marowak"
      ) {
        return this.chainModify(2);
      }
    },
  ...
  timerball: {
    ...
    gen: 3,
    desc:
      "A Poke Ball that becomes better the more turns there are in a battle."
  },
  toxicorb: {
    id: "toxicorb",
    name: "Toxic Orb",
  ...
  ultraball: {
    ...
    gen: 1,
    desc:
      "An ultra-performance Ball that provides a higher catch rate than a Great Ball."
  },
  venusaurite: {
    id: "venusaurite",
    name: "Venusaurite",
  ...
  wateriumz: {
    ...
    gen: 7,
    desc:
      "If holder has a Water move, this item allows it to use a Water Z-Move."
  },
  watmelberry: {
    id: "watmelberry",
    name: "Watmel Berry",
  ...
  wikiberry: {
    ...
    gen: 3,
    desc:
      "Restores 1/2 max HP at 1/4 max HP or less; confuses if -SpA Nature. Single use."
  },
  wiseglasses: {
    id: "wiseglasses",
    name: "Wise Glasses",
  ...
  dragonscale: {
    ...
    isNonstandard: "gen2",
    desc:
      "(Gen 2) Holder's Dragon-type attacks have 1.1x power. Evolves Seadra (trade)."
  },
  goldberry: {
    id: "goldberry",
    name: "Gold Berry",
  ...
  crucibellite: {
    ...
    isNonstandard: true,
    desc:
      "If held by a Crucibelle, this item allows it to Mega Evolve in battle."
  }
};
