...
test("#boostedType()", () => {
  ...
  expect(mysticWater.boostedType()).toBe(Types.WATER);
  expect(zapPlate.boostedType()).toBe(Types.ELECTRIC);
...
test("#berryTypeResist()", () => {
  expect(chopleBerry.berryTypeResist()).toBe(Types.FIGHTING);
  expect(chilanBerry.berryTypeResist()).toBe(Types.NORMAL);
...
test("#naturalGiftType()", () => {
  ...
  expect(chopleBerry.naturalGiftType()).toBe(Types.FIGHTING);
...
test("#gemType()", () => {
  ...
  expect(normalGem.gemType()).toBe(Types.NORMAL);
...
test("#memoryType()", () => {
  ...
  expect(waterMemory.memoryType()).toBe(Types.WATER);
  expect(noItem.memoryType()).toBe(Types.NORMAL);
});
